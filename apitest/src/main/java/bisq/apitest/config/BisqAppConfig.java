...
public enum BisqAppConfig {
    ...
    seednode("bisq-RADC_REGTEST_Seed_2002",
            "bisq-seednode",
            ...
            -1,
            49996),
    arbdaemon("bisq-RADC_REGTEST_Arb_dao",
            "bisq-daemon",
            "-XX:MaxRAM=2g -Dlogback.configurationFile=apitest/build/resources/main/logback.xml",
            ...
            9997,
            49997),
    arbdesktop("bisq-RADC_REGTEST_Arb_dao",
            "bisq-desktop",
            ...
            -1,
            49997),
    alicedaemon("bisq-RADC_REGTEST_Alice_dao",
            "bisq-daemon",
            "-XX:MaxRAM=2g -Dlogback.configurationFile=apitest/build/resources/main/logback.xml",
            BisqDaemonMain.class.getName(),
            7777,
            ...
            9998,
            49998),
    alicedesktop("bisq-RADC_REGTEST_Alice_dao",
            "bisq-desktop",
            ...
            -1,
            49998),
    bobdaemon("bisq-RADC_REGTEST_Bob_dao",
            "bisq-daemon",
            "-XX:MaxRAM=2g -Dlogback.configurationFile=apitest/build/resources/main/logback.xml",
            BisqDaemonMain.class.getName(),
            8888,
            ...
            9999,
            49999),
    bobdesktop("bisq-RADC_REGTEST_Bob_dao",
            "bisq-desktop",
            "-XX:MaxRAM=8g -Dlogback.configurationFile=apitest/build/resources/main/logback.xml",
            BisqAppMain.class.getName(),
            8888,
