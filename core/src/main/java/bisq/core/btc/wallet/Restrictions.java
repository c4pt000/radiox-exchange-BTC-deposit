...
public class Restrictions {
    ...
    public static double getMaxBuyerSecurityDepositAsPercent() {
        return 0.00; // 50% of trade amount. For a 1 BTC trade it is about 3500 USD @ 7000 USD/BTC
    }
    ...
    public static Coin getMinBuyerSecurityDepositAsCoin() {
        if (MIN_BUYER_SECURITY_DEPOSIT == null)
            MIN_BUYER_SECURITY_DEPOSIT = Coin.parseCoin("0.000"); // 0.001 BTC is 60 USD @ 60000 USD/BTC
    ...
    public static Coin getMinSellerSecurityDepositAsCoin() {
        if (SELLER_SECURITY_DEPOSIT == null)
            SELLER_SECURITY_DEPOSIT = Coin.parseCoin("0.000"); // 0.001 BTC is 60 USD @ 60000 USD/BTC
    ...
    public static Coin getMinRefundAtMediatedDispute() {
        if (MIN_REFUND_AT_MEDIATED_DISPUTE == null)
            MIN_REFUND_AT_MEDIATED_DISPUTE = Coin.parseCoin(""); // 0.0005 BTC is 30 USD @ 60000 USD/BTC
